...
export const contentRegistry: ContentEntry[] = [
  ...
  {
    slug: '/',
    title: 'Austin Specialty Shipping & Custom Crating | Furniture Crating & Heavy Collection | Austin Crate & Freight',
    description:
      'Austin Texas specialty shipping & custom crating company. Furniture shipping and crating, fine art transport, heavy package collection, and medical equipment shipping. Museum-quality care. Call (512) 240-9818.',
  ...
  // ── Services ────────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Austin, Texas specialty shipping services. Custom furniture shipping, heavy item collection, fine art crating, oversized freight, and medical equipment transport. White-glove, fully insured.',
    publishDate: '2024-01-01',
    modifiedDate: '2026-02-26',
    category: 'Services',
  ...
  },
  {
    ...
    description:
      'Expert furniture shipping and crating in Austin, Texas. Custom wood crates built in-house, white-glove collection, disassembly & reassembly for designer, antique & heavy furniture. Scratch-free guarantee. Call (512) 240-9818.',
    publishDate: '2024-01-01',
    modifiedDate: '2026-04-27',
    category: 'Services',
    tags: ['furniture shipping and crating Austin Texas', 'furniture crating Austin TX', 'custom furniture crating Austin', 'furniture shipping Austin Texas', 'antique furniture shipping Texas', 'white glove furniture movers Austin', 'heavy furniture collection Austin TX'],
    author: 'Austin Crate & Freight',
    priority: 0.9,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    modifiedDate: '2026-03-07',
    category: 'Services',
    tags: ['oversized furniture shipping Austin Texas', 'heavy furniture shipping Austin TX', 'large furniture crating Austin', 'heavy furniture collection Austin Texas', 'freight furniture shipping Austin'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    description: 'Specialist shipping and crating for designer chairs in Austin, Texas. Eames, Herman Miller, Knoll, Barcelona, and Bertoia chairs — white-glove collection and delivery. Call (512) 240-9818.',
    publishDate: '2026-03-07',
    modifiedDate: '2026-03-07',
    category: 'Services',
  ...
  },
  {
    ...
    title: 'Heavy Item Collection & Shipping Austin TX | Austin Crate & Freight',
    description:
      'Heavy package collection and oversized item shipping in Austin, TX. Custom crating for furniture, equipment, and machinery. Local collection. Call (512) 240-9818.',
    publishDate: '2026-02-26',
    modifiedDate: '2026-04-27',
    category: 'Services',
    tags: ['heavy items', 'heavy package collection', 'oversized shipping', 'Austin TX', 'custom crating', 'specialty shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.9,
    changeFrequency: 'weekly',
  },
  {
    ...
    description:
      'Ship oversized items from Austin, Texas. Custom crating and freight for items too large for FedEx or UPS. White-glove collection, fully insured. Free quotes.',
    publishDate: '2026-02-26',
    modifiedDate: '2026-04-27',
    category: 'Services',
  ...
  // ── Locations ────────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Specialty shipping & custom crating in Round Rock, TX — furniture shipping and crating, fine art transport, heavy item collection & medical equipment. White-glove service. Call (512) 240-9818.',
    publishDate: '2024-01-01',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Round Rock', 'specialty shipping', 'specialty crating', 'furniture shipping and crating', 'custom furniture shipping', 'heavy package collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    ...
    description:
      'Specialty shipping & custom crating in Cedar Park, TX — furniture shipping and crating, fine art transport, heavy item collection & medical equipment. White-glove service. Call (512) 240-9818.',
    publishDate: '2024-01-01',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Cedar Park', 'specialty shipping', 'specialty crating', 'furniture shipping and crating', 'custom furniture shipping', 'heavy package collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    ...
    description:
      'Specialty shipping & custom crating in Georgetown, TX — furniture shipping and crating, antique transport, fine art shipping, heavy item collection & medical equipment. White-glove. Call (512) 240-9818.',
    publishDate: '2024-01-01',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Georgetown', 'specialty shipping', 'specialty crating', 'furniture shipping and crating', 'antique shipping', 'custom furniture shipping', 'heavy package collection', 'Williamson County'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  {
    slug: '/locations/pflugerville',
    title: 'Specialty Shipping & Crating Pflugerville TX | Furniture Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Pflugerville, TX — furniture shipping and crating, fine art transport, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Pflugerville', 'specialty shipping', 'specialty crating', 'furniture shipping', 'heavy item collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/leander',
    title: 'Specialty Shipping & Crating Leander TX | Furniture Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Leander, TX — furniture shipping and crating, fine art transport, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Leander', 'specialty shipping', 'specialty crating', 'furniture shipping', 'heavy item collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/kyle',
    title: 'Specialty Shipping & Crating Kyle TX | Furniture Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Kyle, TX — furniture shipping and crating, fine art transport, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Kyle', 'specialty shipping', 'specialty crating', 'furniture shipping', 'heavy item collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/lakeway',
    title: 'Specialty Shipping & Crating Lakeway TX | Fine Art & Luxury Furniture | Austin Crate',
    description:
      'Specialty shipping & custom crating in Lakeway & Bee Cave, TX — fine art crating, luxury furniture shipping, antique transport & high-value item delivery. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Lakeway', 'Bee Cave', 'specialty shipping', 'fine art shipping', 'luxury furniture shipping', 'antique shipping', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/dripping-springs',
    title: 'Specialty Shipping Dripping Springs TX | Fine Art & Antique Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Dripping Springs, TX — fine art crating, antique furniture shipping, luxury home delivery & Hill Country freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Dripping Springs', 'Hill Country', 'specialty shipping', 'fine art shipping', 'antique shipping', 'luxury furniture shipping', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/buda',
    title: 'Specialty Shipping & Crating Buda TX | Furniture Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Buda, TX — furniture shipping and crating, fine art transport, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Buda', 'specialty shipping', 'specialty crating', 'furniture shipping', 'heavy item collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/hutto',
    title: 'Specialty Shipping & Crating Hutto TX | Furniture & Industrial Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Hutto, TX — furniture shipping, fine art transport, industrial crating, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Hutto', 'specialty shipping', 'specialty crating', 'furniture shipping', 'industrial crating', 'heavy item collection', 'white glove shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    slug: '/locations/manor',
    title: 'Specialty Shipping & Crating Manor TX | Furniture Shipping | Austin Crate',
    description:
      'Specialty shipping & custom crating in Manor, TX — furniture shipping and crating, fine art transport, heavy item collection & oversized freight. White-glove service. Call (512) 240-9818.',
    publishDate: '2026-04-27',
    modifiedDate: '2026-04-27',
    category: 'Locations',
    tags: ['Manor', 'specialty shipping', 'specialty crating', 'furniture shipping', 'heavy item collection', 'white glove shipping', 'East Austin'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    modifiedDate: '2026-02-26',
    category: 'Blog',
    tags: ['cost to ship heavy items Austin', 'heavy package collection', 'custom furniture shipping', 'oversized shipping', 'pricing guide', 'Austin TX'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    description:
      'A practical step-by-step guide to preparing furniture for collection and transit — disassembly, documentation, padding tips, and what to leave for the professionals.',
  ...
  // ── Q3 2026 Location Pages ─────────────────────────────────────────────────
  {
    ...
    description:
      'Specialty shipping and custom crating in San Marcos, TX. Antique shipping, furniture crating, fine art transport, heavy item collection. Serving all of Hays County. Call (512) 240-9818.',
    publishDate: '2026-07-08',
    modifiedDate: '2026-07-08',
    category: 'Locations',
  ...
  },
  {
    ...
    description:
      'Specialty shipping and custom crating in Taylor, TX. Industrial equipment crating, heavy item collection, furniture shipping, and medical equipment transport. Serving Williamson County. Call (512) 240-9818.',
    publishDate: '2026-07-08',
    modifiedDate: '2026-07-08',
    category: 'Locations',
    tags: ['specialty shipping Taylor TX', 'industrial equipment crating Taylor Texas', 'custom crating Taylor TX', 'furniture shipping Taylor', 'heavy item collection Taylor Texas'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    description:
      'Specialty shipping and custom crating in Bastrop, TX. Furniture shipping, antique crating, heavy item collection, and fine art transport for Bastrop homes and businesses. Call (512) 240-9818.',
    publishDate: '2026-07-08',
    modifiedDate: '2026-07-08',
    category: 'Locations',
    tags: ['specialty shipping Bastrop TX', 'antique shipping Bastrop Texas', 'furniture crating Bastrop TX', 'heavy item collection Bastrop TX', 'custom crating Bastrop Texas'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  ...
  },
  {
    ...
    description:
      'Specialty shipping and custom crating in Lockhart, TX. Furniture shipping, heavy item collection, antique crating, and custom packaging for Lockhart homes and businesses. Serving Caldwell County. Call (512) 240-9818.',
    publishDate: '2026-07-08',
    modifiedDate: '2026-07-08',
    category: 'Locations',
    tags: ['specialty shipping Lockhart TX', 'furniture shipping Lockhart Texas', 'heavy item collection Lockhart TX', 'antique shipping Lockhart Texas', 'Caldwell County shipping crating'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
  {
    ...
    description:
      'Specialty shipping and custom crating in Elgin, TX. Furniture shipping, heavy item collection, industrial crating, and custom packaging for Elgin homes and businesses. Serving Bastrop County. Call (512) 240-9818.',
    publishDate: '2026-07-08',
    modifiedDate: '2026-07-08',
    category: 'Locations',
    tags: ['specialty shipping Elgin TX', 'furniture shipping Elgin Texas', 'heavy item collection Elgin TX', 'industrial crating Elgin Texas', 'east Austin corridor shipping'],
    author: 'Austin Crate & Freight',
    priority: 0.8,
    changeFrequency: 'monthly',
  },
