        ...
        <section className="bg-gradient-to-br from-grey-900 to-grey-800 text-white pt-28 md:pt-32 pb-16 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <p className="text-xl text-grey-300 mb-8 max-w-3xl">
              Trade show deadlines are absolute. We schedule carriers that hit show-site delivery windows, log every component, and handle return collections, so your booth arrives ready to build and comes home in one piece.
            </p>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/IMG_3748.jpg"
                alt="Trade show booth shipping Austin Texas"
                fill
