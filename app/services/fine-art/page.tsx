...
export default function FineArtShipping() {
  ...
  const localBusinessSchema = generateLocalBusinessSchema({
    locationName: 'Austin',
    description: 'Fine art specialty shipping in Austin, Texas. Museum-quality crating, climate-controlled transport, and expert art handlers for galleries, collectors, and museums.',
    latitude: 30.2972,
    longitude: -97.7594,
    image: '/1.jpg',
    serviceUrl: '/services/fine-art',
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/1.jpg"
                alt="Fine art specialty shipping Austin Texas, professional museum-quality art transport and crating by Austin Crate & Freight"
                fill
      ...
      {/* Recent Work Gallery (lazy-loaded for SEO + LCP) */}
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Recent Fine Art Crating &amp; Shipping Projects in Austin</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">A look inside our Austin workshop at 3112 Windsor Rd, where every crate is handbuilt for paintings, sculptures, and gallery shipments across Texas and the U.S.</p>
          </div>
      ...
      {/* Find Us / Local Map (strong local SEO signal) */}
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
