        ...
        <section className="bg-gradient-to-br from-grey-900 to-grey-800 text-white pt-28 md:pt-32 pb-16 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/IMG_3954_1686069785125.jpg"
                alt="Glass art shipping and crating Austin Texas"
                fill
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              {[
                ...
                { q: 'What is your lead time for glass art crating?', a: 'Standard glass crating takes 3-5 business days from assessment to ready-for-collection. Complex multi-piece gallery shipments or very large sculptural pieces may require 7-10 business days. Call us with dimensions and we can give you a more specific timeline.' },
              ].map((faq, i) => (
