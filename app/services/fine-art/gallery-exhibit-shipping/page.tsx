          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                ...
                alt="Gallery exhibit shipping Austin Texas"
                fill
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { title: 'Artist Collections & Deliveries', desc: 'We collect from artists\' studios in and around Austin and deliver directly to your gallery. We handle the pieces with the same white-glove standard as a $50,000 work from a major collector.' },
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              {[
                { q: 'Can you accommodate last-minute additions to a show shipment?', a: 'Often yes, but call us as soon as you know. Same-day crating for add-on pieces is possible when our shop schedule allows. We recommend contacting us 5-7 business days before collection to allow time for custom crating, especially for works requiring non-standard crate sizes.' },
                { q: 'Do you provide condition reports that artists and consignors can sign off on?', a: 'Yes. Our condition reports document the state of each work at the time of collection with photographs and written notes. We can share these with consignors for their records. This is standard practice for gallery shipments and protects both the gallery and the consignor.' },
