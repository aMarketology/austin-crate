        ...
        <section className="bg-gradient-to-br from-grey-900 to-grey-800 text-white pt-28 md:pt-32 pb-16 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/IMG_3105.jpg"
                alt="Laboratory equipment shipping Austin Texas"
                fill
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              {[
                ...
                { q: 'What is your coverage for lab equipment in Austin?', a: 'We collect and deliver throughout Greater Austin, the UT campus area, the Domain area, medical district facilities, and surrounding cities including Round Rock, Cedar Park, Georgetown, and Pflugerville.' },
