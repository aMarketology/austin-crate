  ...
  const services = [
    {
      ...
      description: 'Custom crating and white-glove transport for paintings, sculptures, glass art, and rare collectibles. We build climate-controlled crates to museum standard — because your artwork deserves nothing less.',
      image: 'https://images.unsplash.com/photo-1541367777708-7905fe3296c0?w=900&q=80&fit=crop&auto=format',
      href: '/services/fine-art',
      features: ['Climate-Controlled Crating', 'Full Insurance Coverage', 'Gallery-Standard Handling', 'Austin & Nationwide'],
    },
    {
      title: 'Custom Furniture Shipping',
      subtitle: 'White-Glove Service',
      description: 'White-glove custom furniture shipping with expert disassembly, protective crating, and precision reassembly. From designer sofas to antique dining sets — we ship what regular movers refuse.',
      image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=900&q=80&fit=crop&auto=format',
      href: '/services/furniture',
      features: ['Disassembly & Reassembly', 'Protective Wrapping', 'Inside Delivery', 'Scratch-Free Transport'],
    },
    {
      title: 'Medical Equipment',
      subtitle: 'HIPAA Compliant',
      description: 'Specialized transport for imaging systems, surgical equipment, laboratory devices, and sensitive electronics. Chain-of-custody documentation and calibration-safe handling on every job.',
      image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=900&q=80&fit=crop&auto=format',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1553413077-190dd305871c?w=900&q=80&fit=crop&auto=format',
    ...
    },
    {
      ...
      description: 'Ship items too large for FedEx or UPS. Custom crating and freight coordination for furniture, trade show booths, industrial equipment, and any oversized package from Austin, Texas.',
      image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=900&q=80&fit=crop&auto=format',
      href: '/services/oversized-shipping',
      features: ['No Size Limit', 'Door-to-Door', 'Fully Insured', 'Nationwide Delivery'],
    },
  ]
