        ...
        <section className="bg-gradient-to-br from-grey-900 to-grey-800 text-white pt-28 md:pt-32 pb-16 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/1.jpg"
                alt="Oversized shipping when carriers refuse Austin Texas"
                fill
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { title: 'Liftgate Collection & Delivery', desc: 'Freight deliveries to residential or retail addresses require a liftgate truck, which standard carriers do not provide. We coordinate liftgate service at both ends at no surprise to you.' },
                ...
                { title: 'Same-Week Collection in Austin', desc: 'We typically offer collection within 1-3 business days in Austin and the surrounding metro area. If your item needs to move fast, call us directly and we will prioritize your shipment.' },
              ].map((item, i) => (
