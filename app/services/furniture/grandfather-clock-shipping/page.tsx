        ...
        <section className="bg-gradient-to-br from-grey-900 to-grey-800 text-white pt-28 md:pt-32 pb-16 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-grey-700 shadow-xl">
              <Image
                src="/IMG_3770.jpg"
                alt="Grandfather clock shipping Austin Texas"
                fill
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              {[
                { q: 'Do I need to do anything to the clock before you arrive?', a: 'Ideally, let the clock run down naturally or stop the pendulum a few hours before collection. If you are unsure how to stop it safely, leave it, our technicians will stop the movement and remove the pendulum during the packing appointment.' },
