...
export default function CedarPark() {
  const localSchema = generateLocalBusinessSchema({
    ...
    longitude: -97.8203,
    image: '/1.jpg',
    serviceUrl: '/locations/cedar-park',
  })
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden border-2 border-gray-700 shadow-xl">
              <Image
                src="/1.jpg"
                alt="Specialty shipping and custom crating in Cedar Park Texas by Austin Crate & Freight"
                fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden border border-gray-200 shadow-lg">
              <iframe
                ...
                title="Austin Crate & Freight workshop serving Cedar Park TX"
                allowFullScreen
              />
            </div>
          </div>
