...
export const metadata: Metadata = generateLocationMetadata({
  ...
  keywords: [
    ...
    'specialty crating Georgetown TX',
    'specialty crating Georgetown Texas',
    'furniture shipping and crating Georgetown',
    ...
    'Georgetown crating',
    'antique shipping Georgetown TX',
  ],
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-white rounded-xl p-5 border border-emerald-100">
                <h3 className="font-bold text-gray-900 mb-2">Antique & Heirloom Furniture</h3>
                <p className="text-gray-600 text-sm">Georgetown is known for its antique shops. We specialize in crating and shipping antique furniture, period pieces, and heirloom items with the delicacy they deserve.</p>
              </div>
              <div className="bg-white rounded-xl p-5 border border-emerald-100">
                <h3 className="font-bold text-gray-900 mb-2">Fine Art & Collectibles</h3>
                <p className="text-gray-600 text-sm">Museum-standard crating for paintings, sculptures, and gallery pieces. We regularly serve Georgetown galleries, Interior designers, and private collectors.</p>
              </div>
              <div className="bg-white rounded-xl p-5 border border-emerald-100">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Georgetown's Trusted Specialty Shipping Partner</h2>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600">Yes. We coordinate LTL (less-than-truckload) freight nationwide. Items are crated in-house at our Austin facility before being handed off to our carrier network, ensuring protection for the full journey regardless of destination.</p>
              </div>
            </div>
          </div>
