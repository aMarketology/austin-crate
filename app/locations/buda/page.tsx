...
export const metadata: Metadata = generateLocationMetadata({
  locationName: 'Buda',
  description: 'Specialty shipping & custom crating in Buda, TX. Furniture shipping, fine art transport, heavy item collection, and oversized freight. White-glove service from Austin Crate & Freight.',
  keywords: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Austin Crate &amp; Freight brings expert specialty shipping and custom crating to Buda. From Shadow Creek to Sunfield, we serve Buda homes and businesses with furniture shipping, fine art transport, heavy item collection, and oversized freight — all with white-glove care.
              </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              { icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', title: 'Heavy Item Collection', desc: 'Heavy item collection in Buda for safes, appliances, and items too large for standard carriers.', href: '/services/heavy-items' },
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              {[
                { q: 'Do you offer specialty shipping and crating in Buda, TX?', a: 'Yes. Austin Crate & Freight provides comprehensive specialty shipping and custom crating in Buda, Texas. We collect from your Buda location, build custom crates in-house, and deliver locally or ship nationwide.' },
                ...
                { q: 'How far is Buda from your Austin facility?', a: 'Our workshop at 3112 Windsor Rd, Austin is approximately 20 minutes from Buda via I-35. We offer collection throughout Buda and provide same-day and next-day service based on availability.' },
              ].map(({ q, a }) => (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Contact us for a free quote on furniture shipping, heavy item collection, or any specialty shipping need in Buda, TX.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-6">Austin Crate &amp; Freight serves Buda from our workshop at <strong>3112 Windsor Rd, Austin, TX 78703</strong>, just 20 minutes via I-35 South. Collection throughout Buda, TX 78610.</p>
              <ul className="space-y-3 text-gray-700 mb-8">
                ...
                <li className="flex gap-3"><span className="text-emerald-600 font-bold">✓</span><span><strong>Buda collection:</strong> available throughout Buda, Kyle, and Greater Austin</span></li>
              </ul>
