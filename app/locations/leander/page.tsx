...
export const metadata: Metadata = generateLocationMetadata({
  ...
  description: 'Specialty shipping & custom crating in Leander, TX. Furniture shipping, fine art transport, heavy item collection, and oversized shipping. White-glove service from Austin Crate & Freight.',
  keywords: [
    ...
    'heavy item collection Leander TX',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Austin Crate &amp; Freight brings expert specialty shipping and custom crating to Leander. From Crystal Falls to Travisso, we serve Leander homes and businesses with furniture shipping and crating, fine art transport, heavy item collection, and oversized freight — all with museum-quality white-glove care.
              </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              { icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', title: 'Heavy Item Collection', desc: 'Heavy package collection in Leander for safes, appliances, and items too large for standard carriers.', href: '/services/heavy-items' },
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              {[
                { q: 'Do you offer specialty shipping and crating in Leander, TX?', a: 'Yes. Austin Crate & Freight provides comprehensive specialty shipping and custom crating in Leander, Texas. We collect from your Leander location, build custom crates in-house, and deliver locally or ship nationwide.' },
                ...
                { q: 'How quickly can you collect in Leander?', a: 'We offer fast turnaround including same-day and next-day collections for Leander depending on availability. Call (512) 240-9818 to discuss your timeline.' },
              ].map(({ q, a }) => (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Contact us for a free quote on custom furniture shipping, heavy item collection, or any specialty shipping need in Leander, TX.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-6">
                Austin Crate &amp; Freight serves Leander from our workshop at <strong>3112 Windsor Rd, Austin, TX 78703</strong>, just 30 minutes from Crystal Falls. Collection throughout Leander, TX 78641 and 78646.
              </p>
              <ul className="space-y-3 text-gray-700 mb-8">
                ...
                <li className="flex gap-3"><span className="text-emerald-600 font-bold">✓</span><span><strong>Leander collection:</strong> available throughout Leander, Cedar Park, and Greater Austin</span></li>
              </ul>
