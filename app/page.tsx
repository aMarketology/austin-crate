  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="lg:hidden relative min-h-screen flex items-center overflow-hidden bg-grey-50 pt-20 pb-16 px-4">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/60 via-transparent to-grey-100/40" style={{ zIndex: 0 }} />
        ...
        <div className="max-w-xl mx-auto text-center relative z-10 w-full">
          ...
          >
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-emerald/20 bg-white/80 backdrop-blur-sm shadow-sm mb-6">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald"></span>
              </span>
              <span className="text-xs font-semibold text-grey-700 uppercase tracking-[0.2em]">Austin, Texas</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-1"
          >
            <h1 className="font-serif text-5xl sm:text-6xl font-bold text-grey-900 tracking-tight leading-[0.95]">
              Austin Crate
            </h1>
            <h2 className="font-serif text-5xl sm:text-6xl font-bold text-emerald leading-[0.95] tracking-tight">
              & Freight
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            className="mx-auto mt-5 mb-4 h-[2px] w-16 bg-emerald/40 rounded-full origin-center"
          />
          ...
          <motion.p
            ...
            className="font-sans text-base sm:text-lg text-grey-600 mb-8 font-normal leading-relaxed max-w-sm mx-auto px-2"
          >
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-emerald hover:bg-emerald-600 rounded-xl font-semibold text-white text-base shadow-lg shadow-emerald/20 hover:shadow-xl hover:shadow-emerald/30 transition-all hover:scale-[1.02] active:scale-95"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-grey-300 hover:border-emerald rounded-xl font-semibold text-grey-800 text-base hover:bg-emerald/5 shadow-sm transition-all hover:scale-[1.02] active:scale-95"
            >
          ...
          >
            {[
              ...
              <div key={i} className="p-4 bg-white/90 backdrop-blur-sm rounded-2xl border border-grey-200/80 shadow-sm">
                <div className="text-2xl sm:text-3xl font-bold text-emerald mb-0.5">{stat.value}</div>
                <div className="text-[10px] sm:text-xs text-grey-500 uppercase tracking-wider font-medium leading-tight">{stat.label}</div>
              </div>
            ))}
          </motion.div>
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-4 text-xs text-grey-500 px-4"
          >
      ...
      <section className="hidden lg:flex relative min-h-screen items-center overflow-hidden bg-grey-50">
        {/* Subtle gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-white/50 via-transparent to-grey-100/30" style={{ zIndex: 0 }} />
          ...
          <div className="grid grid-cols-12 gap-16 items-center">
            ...
            <div className="col-span-7 space-y-6">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-emerald/20 bg-white/80 backdrop-blur-sm shadow-sm">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald"></span>
                  </span>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className="space-y-1 relative z-50"
              >
                <h1 className="font-serif text-7xl md:text-8xl lg:text-[7rem] font-bold text-grey-900 tracking-tighter leading-[0.9] relative z-50">
                  Austin Crate
                </h1>
                <h2 className="font-serif text-7xl md:text-8xl lg:text-[7rem] font-bold text-emerald leading-[0.9] relative z-50 tracking-tighter">
                  &amp; Freight
                </h2>
              </motion.div>
              ...
              <motion.div
                ...
                animate={{ scaleX: 1 }}
                transition={{ duration: 0.6, delay: 0.5 }}
                className="h-[2px] w-20 bg-emerald/40 rounded-full origin-left"
              />
              ...
              <motion.h3
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.35 }}
                className="font-sans text-2xl md:text-3xl text-grey-700 font-light leading-snug max-w-xl"
              >
              ...
              <motion.p
                ...
                className="font-sans text-lg text-grey-500 font-normal leading-relaxed max-w-lg"
              >
                Expert crating and freight services for fine art, designer furniture, and medical equipment. Museum-quality care, delivered with every shipment.
              </motion.p>
              ...
              >
                <a
                  href="tel:(512) 240-9818"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-emerald rounded-xl font-semibold text-white hover:bg-emerald-600 shadow-lg shadow-emerald/20 hover:shadow-xl hover:shadow-emerald/30 transition-all duration-300 hover:scale-[1.02]"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white border-2 border-grey-300 hover:border-emerald rounded-xl font-semibold text-grey-800 hover:text-emerald hover:bg-emerald/5 shadow-sm transition-all duration-300 hover:scale-[1.02]"
                >
                  Our Services
              ...
              <motion.div
                ...
                className="flex items-center gap-6 pt-4 text-sm text-grey-500"
              >
                <div className="flex items-center gap-1.5">
            ...
            <div className="col-span-5">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Link href="/services/medical-equipment" className="block">
                    <div className="relative h-32 rounded-xl overflow-hidden border border-grey-200 shadow-md bg-white hover:border-emerald transition-all hover:scale-[1.02] cursor-pointer">
                      <Image
                        src="/3.jpg"
                        alt="Medical Equipment Shipping Austin TX - Compliant Device Crating and Transport"
                        fill
                        sizes="(max-width: 1024px) 50vw, 25vw"
                        className="object-cover"
                        quality={75}
                ...
                <div className="pt-3 grid grid-cols-3 gap-3">
                  <div className="p-3 rounded-xl bg-white/90 backdrop-blur-sm border border-grey-200/80 text-center shadow-sm">
                    <div className="text-2xl font-bold text-emerald">15+</div>
                    <div className="text-[10px] text-grey-500 font-medium uppercase tracking-wider">Years</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/90 backdrop-blur-sm border border-grey-200/80 text-center shadow-sm">
                    <div className="text-2xl font-bold text-emerald">100%</div>
                    <div className="text-[10px] text-grey-500 font-medium uppercase tracking-wider">Insured</div>
                  </div>
                  <div className="p-3 rounded-xl bg-white/90 backdrop-blur-sm border border-grey-200/80 text-center shadow-sm">
                    <div className="text-2xl font-bold text-emerald">5 ★</div>
                    <div className="text-[10px] text-grey-500 font-medium uppercase tracking-wider">Rated</div>
                  </div>
                </div>
              </motion.div>
            </div>
